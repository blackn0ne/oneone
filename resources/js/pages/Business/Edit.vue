    ...
    <AppLayout>
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            <div>
                ...
                <p class="text-muted-foreground">Обновите информацию о точке продаж</p>
            </div>
            ...
            <Card>
                <form @submit.prevent="submit">
                    <CardHeader>
                        ...
                        <CardDescription>Обновите данные о точке продаж</CardDescription>
                    </CardHeader>
                    <CardContent class="space-y-4">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            />
                            <Label for="is_active" class="font-medium cursor-pointer">Активна</Label>
                        </div>
